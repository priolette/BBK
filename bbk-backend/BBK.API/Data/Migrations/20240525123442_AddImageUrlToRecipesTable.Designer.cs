...
namespace BBK.API.Data.Migrations
{
    ...
    [Migration("20240525123442_AddImageUrlToRecipesTable")]
    partial class AddImageUrlToRecipesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BBK.API.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 25, 12, 34, 41, 929, DateTimeKind.Unspecified).AddTicks(8886), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 23, 12, 34, 41, 929, DateTimeKind.Unspecified).AddTicks(8888), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 24, 22, 34, 41, 929, DateTimeKind.Unspecified).AddTicks(8894), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedById = "google-oauth2|103919914105442701060",
                            RecipeId = 2,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 25, 12, 29, 41, 929, DateTimeKind.Unspecified).AddTicks(8896), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedById = "auth0|662e3bad87766e08b83e46a0",
                            RecipeId = 2,
            ...
            modelBuilder.Entity("BBK.API.Data.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 25, 15, 34, 41, 929, DateTimeKind.Unspecified).AddTicks(8691), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedById = "google-oauth2|103919914105442701060",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 25, 15, 34, 41, 929, DateTimeKind.Unspecified).AddTicks(8731), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedById = "auth0|662e3bad87766e08b83e46a0",
