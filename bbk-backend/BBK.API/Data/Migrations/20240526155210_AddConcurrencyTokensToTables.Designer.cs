...
namespace BBK.API.Data.Migrations
{
    ...
    [Migration("20240526155210_AddConcurrencyTokensToTables")]
    partial class AddConcurrencyTokensToTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BBK.API.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<uint>("ConcurrecyToken")
                        .IsConcurrencyToken()
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConcurrecyToken = 0u,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 26, 15, 52, 10, 615, DateTimeKind.Unspecified).AddTicks(2453), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 2,
                            ConcurrecyToken = 0u,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 24, 15, 52, 10, 615, DateTimeKind.Unspecified).AddTicks(2455), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 3,
                            ConcurrecyToken = 0u,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 26, 1, 52, 10, 615, DateTimeKind.Unspecified).AddTicks(2460), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedById = "google-oauth2|103919914105442701060",
                            RecipeId = 2,
                        ...
                        new
                        {
                            Id = 4,
                            ConcurrecyToken = 0u,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 26, 15, 47, 10, 615, DateTimeKind.Unspecified).AddTicks(2462), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedById = "auth0|662e3bad87766e08b83e46a0",
                            RecipeId = 2,
            ...
            modelBuilder.Entity("BBK.API.Data.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConcurrecyToken = 0u,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 26, 18, 52, 10, 615, DateTimeKind.Unspecified).AddTicks(2308), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedById = "google-oauth2|103919914105442701060",
                        ...
                        new
                        {
                            Id = 2,
                            ConcurrecyToken = 0u,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 5, 26, 18, 52, 10, 615, DateTimeKind.Unspecified).AddTicks(2343), new TimeSpan(0, 3, 0, 0, 0)),
                            CreatedById = "auth0|662e3bad87766e08b83e46a0",
